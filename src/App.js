...
function App() {
  ...
  const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${state}&appid=${apiKey}`;
      ...
      //https://api.openweathermap.org/data/2.5/weather?q=Irvine=3dc5432cb78a78c4f65f460eace0dbdc
  ...
  const kelvinToFarnheit = (k) => {
    ...
    <div className = "App">
      <header className="d-flex justify-content-center align-items-center">
        <h2>
          React Weather App, {process.env.REACT_APP_API_KEY}
        </h2>
      </header>
      <div className = "container">
        <div className= "mt-3 d-flex flex-column jusify-conten-center align-items-center">
          <div class = "col-auto">
        ...
        <div className = "card mt-3 mx-auto">
          {apiData.main
              ?(<div class = "card-body text-center">
                ...
                <p className= "h2">
                  {kelvinToFarnheit(apiData.main.temp)}&deg; F
                </p>
                <p className= "h5">
                  <FontAwesomeIcon
                    icon = {faMapMarkerAlt}
                ...
                <div className="row mt-4">
                  ...
                  <p>
                    <FontAwesomeIcon
                        ...
                        />?{' '}
                    <strong>
                      {kelvinToFarnheit(apiData.main.temp_min)} &deg; F
                    </strong>
                  </p>
                  <p>
                    <FontAwesomeIcon
                    ...
                    />?{' '}
                    <strong>
                      {kelvinToFarnheit(apiData.main.temp_max)} &deg; F
                    </strong>
                  </p>
                  </div>
                  <div className= "col-md-6">
